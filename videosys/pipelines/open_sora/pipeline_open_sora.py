...
class OpenSoraConfig:
    ...
    def __init__(
        ...
        "/workspace/OpenSora/OpenSora-STDiT-v3",
...
class OpenSoraPipeline(VideoSysPipeline):
    ...
    def generate(
        ...
        for loop_i in range(loop):
            ...
            torch.cuda.synchronize() 
            #t3 = time.time()
            #with open(f"/data/home/scyb091/VideoSys/examples/global_scheduler/log.txt", "a") as f:
            #    f.write(f"dit vae {t2-t1} {t3-t2}\n")
