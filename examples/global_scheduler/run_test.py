...
policies = ["group", "unify", "bandwidth"]
...
base_command3 = "python3 bandwidth_aware_schedule.py --weight1 {x} --weight2 {y} --weight3 {z} --log /home/jovyan/hhy/VideoSys/examples/global_scheduler/logs_{p}_{x}_{y}_{z}.txt"
base_command4 = "python3 bandwidth_aware_schedule.py --weight1 {x} --weight2 {y} --weight3 {z} --group --log /home/jovyan/hhy/VideoSys/examples/global_scheduler/logs_{p}_{x}_{y}_{z}.txt"
base_command5 = "python3 bandwidth_aware_schedule.py --weight1 {x} --weight2 {y} --weight3 {z} --unify --log /home/jovyan/hhy/VideoSys/examples/global_scheduler/logs_{p}_{x}_{y}_{z}.txt"
