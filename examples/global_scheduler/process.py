...
def main(dop: int):
    ...
    print(f"----------P50----------")
    print(np.percentile(final_outputs, 50, interpolation = 'higher'))
    print(f"----------P90----------")
    print(np.percentile(final_outputs, 90, interpolation = 'higher'))
    print(f"----------P99----------")
    print(np.percentile(final_outputs, 99, interpolation = 'higher'))
    print(f"----------SLO5----------")
